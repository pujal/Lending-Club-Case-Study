...
Team Project: Pujal Trivedi and Sohil Grandhi
Problem Statement
Introduction
...
You can access the data dictionary which describes the meaning of these variables from the provided link document.
